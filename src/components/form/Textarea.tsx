import { InputProps, Size } from "./Input";
  ...
  return (
    <>
      <div className={`relative w-full min-w-[200px] ${sizes[size]}`}>
        <textarea
          className={` peer h-full w-full rounded-[7px] border border-blue-gray-200 bg-default px-3 py-2.5 font-sans transition-colors text-sm font-normal text-blue-gray-700 outline-0 focus:border-t-transparent   focus:border-2 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50 focus-visible:outline-0 focus-visible:outline-none ${
            !!error
