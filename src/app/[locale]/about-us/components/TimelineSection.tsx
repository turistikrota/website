...
export default function TimelineSection() {
  ...
  return (
    <section className='container my-24 px-6 mx-auto'>
      ...
      <div className='grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4'>
        <div>
          <h3 className='font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-primary-800 text-center dark:text-primary mt-6'>
            {t('founding.title')}
          </h3>
          <p className='font-normal text-base leading-6 text-gray-600 dark:text-gray-400 text-center mt-6'>
            {t('founding.text')}
          </p>
        </div>
        <div>
      ...
      <div className='sm:hidden grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4'>
        <div>
          <h3 className='font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-primary-800 dark:text-primary text-center mt-6'>
            {t('launch.title')}
          </h3>
          <p className='font-normal text-base leading-6 text-gray-600 dark:text-gray-400 mt-6 text-center'>
            {t('launch.text')}
          </p>
        </div>
      </div>
