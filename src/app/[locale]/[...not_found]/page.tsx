...
export default function NotFoundPage() {
    ...
    return <main className="relative overflow-hidden h-full flex items-center justify-center">
    <section className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
            <h1 className="mb-4 text-7xl tracking-tight font-extrabold lg:text-9xl text-secondary-600 dark:text-secondary-500">404</h1>
